...
import { fetchTrusteeMonthlyDetailedData } from '@/features/trustees/services';
...
const allColumns: Column[] = [
    { header: 'Trustee', accessor: 'debentureTrustee' },
...
export default function TrusteeListPage() {
    ...
    const [sortColumn, setSortColumn] = useState<string>('debentureTrustee');
        ...
        <SkeletonTheme enableAnimation={true} baseColor="#1F2937" highlightColor="#90969bff" borderRadius="0.5rem">
            <div className="min-h-full space-y-4 font-sans text-gray-700 dark:text-gray-200 p-4">
                ...
                <div className="flex flex-col items-start gap-3">
                    ...
                    <div>
                        <h1 className="text-xl font-bold">Trustee List</h1>
                        <p className="text-xs text-gray-500 mt-1 mb-6">Trustee &gt; List</p>
                    </div>
                </div>
