                ...
                <div className={`grid grid-cols-1 md:grid-cols-2 gap-4 ${enableCompare ? 'xl:grid-cols-4' : 'xl:grid-cols-3'}`}>
                    ...
                    <SectionCard className="my-3 relative overflow-hidden group">
                        ...
                        <div className="flex items-start justify-between">
                            <div>
                                <p className="text-[10px] font-medium text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-2">Total Issue Count</p>
                                <div className="space-y-2">
                                    <div className="flex items-baseline gap-2">
                                        <span className="text-2xl font-bold text-[#423CAB]">{primaryTotalCount.toLocaleString()}</span>
                                        <span className="text-[10px] text-gray-400 dark:text-gray-500 font-medium">{primaryYearLabel}</span>
                                    </div>
                                    {enableCompare && (
                                        <div className="flex items-baseline gap-2 pt-1 border-t border-gray-100 dark:border-gray-700">
                                            <span className="text-xl font-bold text-[#06B6D4]">{compareTotalCount.toLocaleString()}</span>
                                            <span className="text-[10px] text-gray-400 dark:text-gray-500 font-medium">{compareYearLabel}</span>
                                        </div>
                                    )}
                                </div>
                            </div>
                    ...
                    <SectionCard className="my-3 relative overflow-hidden group">
                        ...
                        <div className="flex items-start justify-between">
                            <div>
                                <p className="text-[10px] font-medium text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-2">Total Issue Size</p>
                                <div className="space-y-2">
                                    <div className="flex items-baseline gap-2">
                                        <span className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">₹{formatNumber(primaryTotalSize)}</span>
                                        <span className="text-[10px] text-gray-400 dark:text-gray-500 font-medium">{sizeUnit}</span>
                                    </div>
                                    <span className="text-[10px] text-gray-400 dark:text-gray-500 font-medium block">{primaryYearLabel}</span>
                                    {enableCompare && (
                                        <div className="space-y-1 pt-1 border-t border-gray-100 dark:border-gray-700">
                                            <div className="flex items-baseline gap-2">
                                                <span className="text-xl font-bold text-[#06B6D4]">₹{formatNumber(compareTotalSize)}</span>
                                                <span className="text-[10px] text-gray-400 dark:text-gray-500 font-medium">{sizeUnit}</span>
                                            </div>
                                            <span className="text-[10px] text-gray-400 dark:text-gray-500 font-medium block">{compareYearLabel}</span>
                                        </div>
                                    )}
                                </div>
                            </div>
                    ...
                    <SectionCard className="my-3 relative overflow-hidden group">
                        ...
                        <div className="flex items-start justify-between">
                            <div>
                                <p className="text-[10px] font-medium text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-2">Avg Monthly Issue Size</p>
                                <div className="space-y-2">
                                    <div className="flex items-baseline gap-2">
                        ...
                        <SectionCard className="my-3 relative overflow-hidden group">
                            ...
                            <div className="flex items-start justify-between">
                                <div className="w-full">
                                    <p className="text-[10px] font-medium text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-3">YoY Growth</p>
