    ...
    return (
        <SkeletonTheme enableAnimation={true} baseColor="#1F2937" highlightColor="#90969bff" borderRadius="0.5rem">
            <div className="min-h-full space-y-4 font-sans text-gray-700 dark:text-gray-200 p-4">
                {/* Header */}
                <div>
                    <h1 className="text-xl font-bold text-gray-700 dark:text-gray-200">Rating Agencies List</h1>
                    <p className="text-[9px] text-gray-400 mb-6 mt-1">Rating Agency &gt; List</p>
                </div>
                                        ...
                                        {sortedData.map((row, index) => (
                                            ...
                                            >
                                                {filteredColumns.map((column) => (
                                                    <td
                                                        key={column.accessor}
                                                        className={`border border-gray-200 dark:border-gray-700 rounded-md px-3 py-3 font-medium break-words min-w-[120px] text-gray-800 dark:text-gray-200 ${
