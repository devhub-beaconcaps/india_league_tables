...
function MonthWiseTable({
    ...
    const handleClick = (
        ...
        router.push(
            `/agencies/list?period=${encodeURIComponent(period)}&fy=${fy}`
        );
    };
    ...
    return (
        ...
        >
            <div className="min-h-full p-4 md:p-6 space-y-4 font-sans text-gray-700 dark:text-gray-200">
                ...
                {/* ── Page Title ── */}
                <div>
                    <h1 className="text-xl font-bold text-gray-700 dark:text-gray-200">Rating Agencies Monthly Summary</h1>
                    <p className="text-[9px] text-gray-400 mb-6 mt-1">Rating Agencies &gt; Monthly Summary</p>
                </div>
