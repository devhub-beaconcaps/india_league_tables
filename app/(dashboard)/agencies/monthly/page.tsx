...
function MonthWiseTable({
    ...
    const handleClick = (row: ChartData, type: 'primary' | 'compare') => {
        ...
        router.push(`/agencies/list?period=${encodeURIComponent(period)}&fy=${fy}`);
    };
    ...
    return (
        ...
        >
            <div className="min-h-full space-y-4 font-sans text-gray-700 dark:text-gray-200">
                ...
                {/* ── Page Title ── */}
                <div>
                    <h1 className="text-xl font-bold text-gray-700 dark:text-gray-200">Rating Agnecies Monthly Summary</h1>
                    <p className="text-[9px] text-gray-400 mb-6 mt-1">Rating Agnecies &gt; Monthly Summary</p>
                </div>
