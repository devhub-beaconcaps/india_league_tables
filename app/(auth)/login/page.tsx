        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8 bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg dark:shadow-gray-900/50">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    {/* Email Field */}
                    <div>
                        <label htmlFor="email" className="block text-[11px] font-medium text-gray-700 dark:text-gray-300">
                            Email address
                        </label>
                        <div className="mt-1">
                            <input
                    ...
                    {/* Password Field */}
                    <div>
                        <label htmlFor="password" className="block text-[11px] font-medium text-gray-700 dark:text-gray-300">
                            Password
                        </label>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            />
                            <label htmlFor="remember-me" className="ml-2 block text-[11px] text-gray-900 dark:text-gray-300">
                                Remember me
                            </label>
                        </div>
